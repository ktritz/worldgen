...
OUT_DIR="${OUT_DIR:-$ROOT_DIR/output/review_planets/sweeps/level67_resolution_civ_v50_validation}"
...

{
  ...
  echo "purpose=matched_l6_l7_resolution_civilization_v50_validation"
